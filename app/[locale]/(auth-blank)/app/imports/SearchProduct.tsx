...
import { searchProduct } from "@/hooks/api";
  ...
  React.useEffect(() => {
    if (commandInput !== "") {
      const fetchResults = async () => {
        const searchResults = await searchProduct(commandInput);
          ...
          <div className="p-4 border-b">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium text-gray-900 truncate">{selectedItem.itemName}</p>
